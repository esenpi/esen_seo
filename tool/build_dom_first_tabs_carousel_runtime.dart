...
const _entrypoint = 'tool/dom_first_tabs_carousel_entrypoint.dart';
const _generated =
    'lib/src/renderer/seo_dom_first_tabs_carousel_runtime.g.dart';

Future<void> main(List<String> arguments) async {
  final write = arguments.contains('--write');
  if (arguments.any((argument) => argument != '--write')) {
    stderr.writeln(
      'Usage: dart run tool/build_dom_first_tabs_carousel_runtime.dart '
      '[--write]',
    );
    exitCode = 64;
    return;
  ...
  final temp =
      await Directory.systemTemp.createTemp('esen-dom-first-tabs-carousel-');
  try {
    final output = '${temp.path}/tabs_carousel.js';
    ...
    final unformattedSource =
        '// Generated by tool/build_dom_first_tabs_carousel_runtime.dart.\n'
        '// Do not edit by hand.\n'
        'const String seoDomFirstTabsCarouselRuntime = $encoded;\n';
    ...
    stdout.writeln('DOM-first tabs + carousel runtime is current.');
  } finally {
