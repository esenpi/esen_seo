...
const _entrypoint = 'tool/dom_first_carousel_entrypoint.dart';
const _generated = 'lib/src/renderer/seo_dom_first_carousel_runtime.g.dart';

Future<void> main(List<String> arguments) async {
  final write = arguments.contains('--write');
  if (arguments.any((argument) => argument != '--write')) {
    stderr.writeln('Usage: dart run tool/build_dom_first_carousel_runtime.dart '
        '[--write]');
    exitCode = 64;
    return;
  }
  ...
  final temp =
      await Directory.systemTemp.createTemp('esen-dom-first-carousel-');
  try {
    final output = '${temp.path}/carousel.js';
    ...
    final unformattedSource =
        '// Generated by tool/build_dom_first_carousel_runtime.dart.\n'
        '// Do not edit by hand.\n'
        'const String seoDomFirstCarouselRuntime = $encoded;\n';
    ...
    stdout.writeln('DOM-first carousel runtime is current.');
  } finally {
