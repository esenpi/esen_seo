...
const _entrypoint = 'tool/dom_first_collection_entrypoint.dart';
const _generated = 'lib/src/renderer/seo_dom_first_collection_runtime.g.dart';

Future<void> main(List<String> arguments) async {
  final write = arguments.contains('--write');
  if (arguments.any((argument) => argument != '--write')) {
    stderr
        .writeln('Usage: dart run tool/build_dom_first_collection_runtime.dart '
            '[--write]');
    exitCode = 64;
    return;
  }
  ...
  final temp =
      await Directory.systemTemp.createTemp('esen-dom-first-collection-');
  try {
    final output = '${temp.path}/collection.js';
    ...
    final unformattedSource =
        '// Generated by tool/build_dom_first_collection_runtime.dart.\n'
        '// Do not edit by hand.\n'
        'const String seoDomFirstCollectionRuntime = $encoded;\n';
    ...
    stdout.writeln('DOM-first collection runtime is current.');
  } finally {
